...
CREATE TABLE `jobs` (
  ...
  `job_first_segment` bigint unsigned NOT NULL,
  `job_last_segment` bigint unsigned NOT NULL,
  `id_translator` varchar(100) DEFAULT '',
  `tm_keys` text NOT NULL,
  `job_type` varchar(45) DEFAULT NULL,
  `source` varchar(45) DEFAULT NULL,
  `target` varchar(45) DEFAULT NULL,
  `total_time_to_edit` bigint DEFAULT '0',
  `only_private_tm` int NOT NULL DEFAULT '0',
  `last_opened_segment` int DEFAULT NULL,
  `id_tms` int DEFAULT '1',
  `id_mt_engine` int DEFAULT '1',
  `create_date` datetime NOT NULL,
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `revision_stats_typing_min` int NOT NULL DEFAULT '0',
  `revision_stats_translations_min` int NOT NULL DEFAULT '0',
  `revision_stats_terminology_min` int NOT NULL DEFAULT '0',
  `revision_stats_language_quality_min` int NOT NULL DEFAULT '0',
  `revision_stats_style_min` int NOT NULL DEFAULT '0',
  `revision_stats_typing_maj` int NOT NULL DEFAULT '0',
  `revision_stats_translations_maj` int NOT NULL DEFAULT '0',
  `revision_stats_terminology_maj` int NOT NULL DEFAULT '0',
  `revision_stats_language_quality_maj` int NOT NULL DEFAULT '0',
  `revision_stats_style_maj` int NOT NULL DEFAULT '0',
  `dqf_key` varchar(255) DEFAULT NULL,
  `avg_post_editing_effort` float DEFAULT '0',
  `total_raw_wc` bigint DEFAULT '1',
  `editing_time` bigint NOT NULL DEFAULT '0',
  `tm_pretranslate` int NOT NULL DEFAULT '0',
  `mt_pretranslate` int NOT NULL DEFAULT '0',
  `start_tm_pretranslate` int NOT NULL DEFAULT '0',
  `start_mt_pretranslate` int NOT NULL DEFAULT '0',
...
CREATE TABLE `projects` (
  ...
  `create_date` datetime NOT NULL,
  `id_engine_tm` int DEFAULT NULL,
  `id_engine_mt` int DEFAULT NULL,
  ...
  `instance_id` tinyint DEFAULT NULL,
  `pretranslate_100` int DEFAULT '0',
  `id_qa_model` int DEFAULT NULL,
  `id_assignee` int unsigned DEFAULT NULL,
  `due_date` datetime DEFAULT NULL,
  `mt_system_id` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `segment_translations` (
  ...
  `autopropagated_from` bigint DEFAULT NULL,
  `status` varchar(45) DEFAULT 'NEW',
  `translation` text,
  `translation_date` datetime DEFAULT NULL,
  `time_to_edit` int NOT NULL DEFAULT '0',
  ...
  `suggestion` text,
  `suggestion_match` int DEFAULT NULL,
  `suggestion_source` varchar(45) DEFAULT NULL,
  `suggestion_position` int DEFAULT NULL,
  ...
  `save_type` varchar(50) DEFAULT NULL,
  `save_match` int DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `tm_pretranslate` int NOT NULL DEFAULT '0',
  `mt_pretranslate` int NOT NULL DEFAULT '0',
  `update_mt` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`),
...
CREATE TABLE `memory_settings` (
  ...
  `write_memory` int NOT NULL DEFAULT '0',
  `user_id` bigint NOT NULL,
  `concordance_search` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `project_memory_settings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `memory_id_project_settings_id` (`memory_id`,`project_settings_id`),
  KEY `fk_project_memory_settings_project_settings_id` (`project_settings_id`),
  CONSTRAINT `fk_project_memory_settings_project_settings_id` FOREIGN KEY (`project_settings_id`) REFERENCES `project_settings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8;

-- 2020-06-19_alter_update_mt.sql
ALTER TABLE `users`
